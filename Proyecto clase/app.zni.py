...
ruta_zni = 'data/Estado_de_la_prestación_del_servicio_de_energía_en_Zonas_No_Interconectadas_20260422.csv'

ruta_divipola = 'data/DIVIPOLA_-_Códigos_cabeceras_-_Centros_poblados_20260429.csv'
